  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-[0_1px_3px_rgba(0,0,0,0.08),0_4px_12px_rgba(0,0,0,0.04)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-22 md:h-28 items-center justify-between">
              ...
              link.label === "Services" ? (
                <div key={link.label}>
                  <button
                    ...
                    className="flex items-center justify-between w-full px-3 py-2.5 text-base font-medium rounded-lg hover:bg-muted"
                  >
                    Services
                    <ChevronDown
                  ...
                  {servicesOpen && (
                    <div className="ml-4 mt-1 space-y-0.5">
                      <Link
                        ...
                        className="block px-3 py-2 text-sm font-medium text-brand rounded-lg hover:bg-muted"
                      >
                        All Services
                      </Link>
                      {PRIMARY_SERVICES.map((service) => (
                        <Link
                          ...
                          href={`/services/${service.slug}`}
                          onClick={() => setMobileOpen(false)}
                          className="block px-3 py-2 text-sm text-foreground/70 rounded-lg hover:bg-muted"
                        >
                          {service.title}
                        </Link>
                      ))}
                ...
                <Link
                  ...
                  href={link.href}
                  onClick={() => setMobileOpen(false)}
                  className="block px-3 py-2.5 text-base font-medium rounded-lg hover:bg-muted"
                >
                  {link.label}
                </Link>
              )
